...
class CharacterClassSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $classes = [
            ...
            'starting_armor' => 1, 'options' => "{\"sense_range\":5}"],
            ...
            'starting_armor' => 2, 'options' => "{\"sense_range\":10,\"prefDist\":4,\"attackCooldown\":2,\"moveOrAttack\":0}"],
            ...
            'starting_armor' => 6, 'options' => "{\"sense_range\":15}"],
            ...
            'starting_armor' => 3, 'options' => "{\"sense_range\":10,\"prefDist\":5,\"attackCooldown\":2,\"moveOrAttack\":0}"],
            ...
            'starting_armor' => 8, 'options' => "{\"sense_range\":20,\"prefDist\":3,\"attackCooldown\":3,\"moveOrAttack\":0}"],
        ];
